...
function TimeMenu() {
  ...
  return (
    <div className="relative flex h-[43px] w-auto items-center gap-x-[15px] border-b-[1px] border-[#8E8E8E] pb-[14px] text-body-2 uppercase mobile:w-[97px] mobile:pl-4">
      ...
      <Arrow
        ...
        onKeyDown={(e: KeyboardEvent) =>
          e.key === "Enter" && setOpenMenu(!openMenu)
        }
      />

      {openMenu && (
        <ul className="absolute left-0 top-[3.2rem] z-50 flex h-[103px] w-[106px] flex-col items-center gap-y-4 bg-white pt-[18px] shadow-2xl">
