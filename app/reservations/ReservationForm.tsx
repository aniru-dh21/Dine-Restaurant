...
const ReservationsFormSchema = z.object({
  ...
  hour: z.string().nonempty("This field is incomplete"),
  minute: z.string().nonempty("This field is incomplete"),
...
function ReservationForm() {
  ...
  return (
    <motion.section
      ...
      className="flex h-auto w-full flex-col bg-white p-4 shadow-3xl small-mobile:p-8 sm:p-12"
    >
      ...
      <FormProvider {...createReservationForm}>
        ...
        >
          ...
          <Form.Field className="max-sm:flex-col max-sm:items-start">
            <div>
              <h4
                className={`text-body-2 max-sm:mb-2 ${errors.hour ? "text-red-700" : "text-black"}`}
              >
                Pick a hour
              </h4>
