...
import ReservationsLogo from "./ReservationLogo";
  ...
  return (
    <main className="max-sm:mb-[534px] max-lg:sm:mb-[435px]">
      <section className="relative flex h-[600px] w-full justify-center">
        <section className="relative z-50 flex h-auto w-full flex-col max-sm:mx-6 max-sm:items-center max-lg:sm:px-10 max-xl:lg:px-6 xl:w-[1110px]">
          <ReservationsLogo />
          <section className="flex w-full justify-between max-lg:flex-col max-lg:items-center sm:flex">
            <MainTexts />
