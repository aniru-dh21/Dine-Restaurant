...
function Characteristics() {
  ...
  return (
    <section className="flex h-auto w-full flex-col items-center gap-y-[118px] md:gap-y-32">
      <section className="relative flex w-full items-center justify-center max-xl:px-6 max-md:flex-col md:justify-between xl:w-[1110px]">
        <InView triggerOnce threshold={0.5}>
          {({ inView, ref }) => (
            <motion.div
              ref={ref}
              className="items-center justify-center max-md:flex"
        ...
        <motion.div
          className="mt-[321px] flex w-[75%] flex-col max-md:items-center max-md:text-center sm:mt-[289px] sm:w-[457px] md:mt-[177px] md:w-[40%] lg:w-[445px]"
          variants={container}
          initial="hidden"
          whileInView="show"
          viewport={{ once: true }}
        >
          ...
          <motion.h1
            variants={item}
            className="mb-[27px] mt-[55px] text-[32px] font-bold text-ebony-clay sm:text-5xl"
          >
            Enjoyable place for all the family
          </motion.h1>
          <motion.p
            variants={item}
            className="text-base text-ebony-clay sm:text-body-2"
          >
      ...
      <section className="flex w-full items-center justify-between max-xl:px-6 max-md:flex-col md:mt-[12rem] md:flex-row-reverse xl:w-[1110px]">
          ...
          {({ inView, ref }) => (
            ...
            >
              ...
              <Image
                ...
                placeholder="blur"
                priority
                className="h-[400px] w-[327px] object-cover sm:top-[-8rem] sm:h-[360px] sm:w-[573px] md:hidden"
              />
              <PatternLines className="absolute right-[-3.5rem] top-[228px] z-[60] md:right-[-5rem] md:top-[282px] xl:right-[-7.5rem]" />
            </motion.div>
          )}
        </InView>

        <motion.div
          className="flex w-[75%] flex-col max-md:mt-14 max-md:items-center max-md:text-center sm:w-[457px] md:w-[40%] lg:w-[445px]"
          variants={container}
          initial="hidden"
          whileInView="show"
          viewport={{ once: true }}
