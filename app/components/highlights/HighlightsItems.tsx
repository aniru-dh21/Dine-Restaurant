...
function HighlightsItems({ name, description, src }: HighlightsItemsProps) {
  return (
    <div className="flex h-fit gap-x-[30px] max-sm:flex-col max-sm:items-center max-sm:text-center">
      <div className="flex">
        <Image
          width={256}
          height={192}
